...
import contactImage from '../assets/6-1.png';
          ...
          <div className="container mx-auto px-4 py-8 relative z-10">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white">
                ...
                <span className="text-pollinate-yellow">Amazing</span>{" "}
                Together
              </h1>
              <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-gray-200">
                Have questions or ready to start your next project? Get in touch with our team of experts and let's transform your vision into reality.
              </p>
            </div>
          </div>
        </div>
      </div>
      <ContactForm showMap={true} showInfo={true} />
    </Layout>
  );
};

...
import portfolioImage from '../assets/portfolio3.jpg';
          ...
          <div className="container mx-auto px-4 py-8 relative z-10">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white">
                ...
                <span className="text-pollinate-yellow">Solutions</span>{" "}
                for Your Business
              </h1>
              <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-gray-200">
                We offer a comprehensive range of digital services to help your business grow and succeed in the digital landscape with cutting-edge technology and innovative solutions.
              </p>
            </div>
          </div>
        </div>
